...
These transitions can also occur on much shorter timescales,where individual larvae switched between abnormal and normal swimming within minutes. 
For example, a mutant larva exhibiting strong unbalanced swimming was observed swimming normally approximately 3 minutes later in the same recording session (\autoref{videosupp:transience1}).
