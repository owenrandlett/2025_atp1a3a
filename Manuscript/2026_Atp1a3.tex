...
\videosupp{Transience of the unbalanced swimming phenotype in an \emph{atp1a3a} mutant larva. Both panels show the same larva, recorded in a single continuous session, with elapsed time indicated at the top right of each panel.
