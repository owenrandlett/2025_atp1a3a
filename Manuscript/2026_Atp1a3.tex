...
\subsubsection{Induced turning and swimming in the optomotor response (OMR) assay}
...
Beyond a simple difference in the number of tuned neurons to motor-phenotypes, the nature of the activity pattern in these clusters of neurons is clearly very different in the mutant forebrain, and this altered pattern is the most obvious and striking aspect of these data (\autoref{fig:S6b}). 
...
For this reason, it is still somewhat unclear to what extent they will be truely useful in modeling movement disorders like AHC and RDP, which are thought to arise from dysfunction in complex forebrain structures, the cerebellum, or in a very distributed and perhaps human-specific way.
...
It may not be possible to answer this question \emph{a priori}, the first and most relevant step is a thorough analysis of the behavioual phenotypes present in the model. 
...
Therefore, based on these parallels we can proceed with confidence that the \emph{atp1a3a} mutant zebrafish can be a relevant model for ATP1A3-related disorders, and that the phenotypes we observe can be used as a basis for further mechanistic and therapeutic studies.
...
While this awaits a more comprehensive understanding of the neurological basis, the "unbalanced swimming" could perhaps be understood as a model of ataxic behaviour, and the "bent tail" phenotypes could be related to dystonic postures, or perhaps hemiplegic postures, given that the tail is often persistently bent to one side for many seconds. This could either indicate lateralized contraction, or conversely, lateralized paralaysis.
...
This may also explain the seemingly more severe neurophysiological phenotypes we observe in the head-embedded preparation relative to the freely swimming pERK/MAP-Mapping experiments. 
If future analyses are able to identify specific and reliable stressors that can trigger the postural phenotypes in \emph{atp1a3a} mutants, this may provide an invaluable model for understanding the mechanisms of symptom transience in ATP1A3-related disorders, and for screening for drugs that can prevent or relieve these catastrophic symptoms.
...
From this we concluded that the average mutant brain appears to be relatively normal physiologically, with only isolated areas showing significant alterations in activity (under these conditions and with this method). 
...
While it is true that much of the brain appeared normal in our MAP-Maps, a dramatic pattern of altered activity was seend in the forebrain, including the telencephalon (pallium and subpallium) and habenula. 
These areas, and especially the telencephalon, are not typically associated with sensorimotor processing in larval zebrafish, but are more associated with higher-order sensory processing, internal state regulation, and action selection.
We believe that this pattern of altered forebrain activity may be critical to the altered states observed in \emph{atp1a3a} mutants, because they were consistently observed across different stimulus contexts, including the presentation of DF and OMR stimuli.

These stimuli elicit different patterns of altered activity in other areas such as the optic tectum and hindbrain, but the same telencephalon/habneula pattern was observed.
...
However, this causal relationship will need to be tested in future experiments, for example by using optogenetic or chemogenetic methods to manipulate activity in these areas and determine how this affects the phenotypes observed in \emph{atp1a3a} mutants.
...
While this loss of functionally defined neurons was distributed across most brain areas we analyzed, it was most extreme in the pallium, subpallium and habenula. 
...
This loss of sensory-tuning can not be explained simply by a lack of neuronal activity or generalized loss of tuning, as we observed an opposing pattern for the number of neurons that are tuned to motor variables -- either swimming vigor or the slower dymanics in the tail angle. This increas in motor-turning populations was observed consistently as a trend across all brain areas, but was most prominent in the diencephalon and did not reach statistical significance in the telencephalon and habenula. Similarly, the number of "uncategorized" neurons that were not tuned to any of the sensory or motor variables we analyzed was significantly increased in mutants relative to siblings. Therefore, the mutant forebrain is not simply hypoactive or lacking in tuning, but shows a complex pattern of imbalanced sensorimotor representation, with a reduction in sensory-tuned neurons and an increase in motor-related and unidentified signals.
...
Further characterization of their cell-type specific characteristics, spatial and temporal dynamics, as well as their relationship to motor phenotypes, will be an important next step in understanding the pathophysiology of these mutants. 
...
Our comprehensive behavioural and neurological analyses of \emph{atp1a3a} mutant zebrafish larvae have revealed a complex and nuanced picture of the phenotypes associated with ATP1A3-loss in this model system, which we believe are relevant to the human disease condition and can be used as a basis for further mechanistic and therapeutic studies.
This model we have generated is a simple loss-of-function model, which is relevant to the human disease condition as many of the mutations that cause ATP1A3-related disorders are thought to cause loss of function. 
However, all of the patient-associated mutations that have been identified to date are heterozygous point mutations, which may have more complex and perhaps more dominant effects on the function of the protein or the Na\textsuperscript{+}/K\textsuperscript{+}-ATPase itself, and thus may not be fully captured by a simple loss-of-function model.
Most of the phenotypes we observe in \emph{atp1a3a} mutants are recessive, and so this inheritance pattern is a major distinction between our model and the human disease. However, in this project we have completely ignored the potential role of the \emph{atp1a3b} paralog, which is also expressed in the brain and may have some functional redundancy with \emph{atp1a3a}. This is very possible, as the previously reported hyperactivity/insomnia phenotypes were seen in both \emph{atp1a3a} and \emph{atp1a3b} mutants \citep{Barlow2023}, and thus the presence of this paralog may be sufficient to prevent the manifestation of phenotypes in heterozygous \emph{atp1a3a} mutants.
