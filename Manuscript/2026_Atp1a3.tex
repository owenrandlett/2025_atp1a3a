...
\subsection{Zebrafish larvae as models for complex movement disorders like AHC and RDP}

Larval zebrafish are a powerful model for genetics and systems neuroscience, but as a very immature non-mammalian vertebrate, there are some limitations to their use as models for human neurological diseases.
Therefore, it is unclear to what extent they will be useful in modeling complex movement disorders like AHC and RDP, which are thought to arise from dysfunction in complex circuits within the basal ganglia and related forebrain structures, the cerebellum, or in a very distributed and perhaps human-specific way.
...
Therefore, it is critical to determine whether the phenotypes we observe in \emph{atp1a3a} mutants are relevant to the human disease, and whether they can be used as a basis for further mechanistic and therapeutic studies.  

Proof of concept for the relevance of zebraifsh model comes from Dravet syndrome, where \emph{scn1lab} mutant larvae show spontaneous seizure-like behavior and epileptiform brain activity, and they often show poor response to sodium-channel blockers, thus showing high phenotypic similarity to the human condition \citep{Baraban2013-NC, Dinday2015-EN}. 
Large-scale larval screens identified clemizole and later lorcaserin as seizure-suppressing hits that act via serotonergic pathways, eventually leading to clinical trials and motivating human use of serotonergic agents, including fenfluramine, which has been approved as a clinical treatment \citep{Lagae2019-LS, Nabbout2020-JAMA}. 

Based on previous work with morpholinos and \emph{atp1a3a/b} mutants, it was unclear to what extent we might be able to model ATP1A3-related disorders like AHC and RDP in larval zebrafish, because the phenotypes reported, including brain ventricle malformation, or hyerpactivity, seem very distinct from the relevant human phenotypes. 
However, our comprehensive behavioural and neural phenotyping of \emph{atp1a3a} mutants has revealed a much more complex and nuanced picture, where mutants show a range of different phenotypes across different contexts, including postural problems, hyper- and hypo-activity, reduced responses to visual stimuli, and increased responses to acoustic/tap stimuli.
...
\subsection{The behavioural and neural effects of \emph{atp1a3a} loss are complex and context-dependent}

\subsection{Understanding the circuit-level mechanisms underlying the phenotypes in \emph{atp1a3a} mutants and their implications for disease}
