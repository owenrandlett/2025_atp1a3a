...
Based on our MAP-Mapping results, we expected to see a reduction in sensory-related responses in the forebrain of \emph{atp1a3a} mutants, and perhaps specific altered signals related to swimming dynamics and/or postural bending. 
To analyze the Ca\textsuperscript{2+} imaging data, we segmented the imaging data into ROIs using suite2p \citep{Pachitariu2016}, which mostly (but not exlusively) identifies individual neuronal soma, here referred to as identified "neurons". Using regressor-based analyses \citep{Miri2011}, we identified neurons that show significant responses to the DF and OMR stimuli, as well as neurons that show significant correlations with either swimming vigor or tail angle dynamics, as well as any neurons showing significant variations in their activity across the 15-minute recording period.
